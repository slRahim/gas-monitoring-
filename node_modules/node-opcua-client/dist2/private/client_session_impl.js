        ...
        if (privateThis.pendingTransactionsCount > 0) {
            ...
            if (privateThis.pendingTransactions.length > 10) {
                if (!pendingTransactionMessageDisplayed) {
                    ...
                    // tslint:disable-next-line: no-console
                    warningLog("[NODE-OPCUA-W22]", chalk.yellow("Warning : your opcua client is sending multiple requests simultaneously to the server", request.constructor.name), chalk.yellow(" => please fix your application code"));
                }
            }
