...
export declare class ClientMonitoredItemGroupImpl extends EventEmitter implements ClientMonitoredItemGroup {
    ...
    constructor(subscription: ClientSubscription, itemsToMonitor: any[], monitoringParameters: any, timestampsToReturn: TimestampsToReturn, monitoringMode?: MonitoringMode);
    toString(): string;
    /**
     * @method terminate
