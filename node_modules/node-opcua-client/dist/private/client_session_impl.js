...
class ClientSessionImpl extends events_1.EventEmitter {
    ...
    get isReconnecting() {
        var _a;
        return this._client
            ? (this._client.isReconnecting || ((_a = this._reconnecting) === null || _a === void 0 ? void 0 : _a.reconnecting))
            : false;
    }
    getPublishEngine() {
    ...
    getBuiltInDataType(...args) {
        const nodeId = args[0];
        const callback = args[1];
        return node_opcua_pseudo_session_1.getBuiltInDataType(this, nodeId, callback);
    }
    resumePublishEngine() {
    ...
    extractNamespaceDataType() {
        return __awaiter(this, void 0, void 0, function* () {
            return node_opcua_client_dynamic_extension_object_1.getExtraDataTypeManager(this);
        });
    }
    getExtensionObjectConstructor(dataTypeNodeId) {
        return __awaiter(this, void 0, void 0, function* () {
            return node_opcua_client_dynamic_extension_object_1.getExtensionObjectConstructor(this, dataTypeNodeId);
        });
    }
    /**
     *
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const promises = callMethodResult.outputArguments.map((value) => __awaiter(this, void 0, void 0, function* () {
            if (value.dataType === node_opcua_variant_1.DataType.ExtensionObject) {
                yield node_opcua_client_dynamic_extension_object_1.resolveDynamicExtensionObject(session, value, extraDataTypeManager);
            }
        }));
