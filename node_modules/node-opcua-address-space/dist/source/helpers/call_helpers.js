...
function callMethodHelper(context, addressSpace, callMethodRequest, callback) {
    ...
    resolve_opaque_on_address_space_1.resolveOpaqueOnAddressSpace(addressSpace, inputArguments)
        .then(() => {
        methodObj.execute(object, inputArguments, context, (err, callMethodResponse) => {
            ...
            resolve_opaque_on_address_space_1.resolveOpaqueOnAddressSpace(addressSpace, outputArguments)
