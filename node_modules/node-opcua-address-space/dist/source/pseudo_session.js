...
const errorLog = node_opcua_debug_1.make_errorLog("PseudoSession");
/**
...
class PseudoSession {
    constructor(addressSpace, context) {
        ...
        this._sessionId = new node_opcua_nodeid_1.NodeId(node_opcua_nodeid_1.NodeIdType.GUID, node_opcua_basic_types_1.randomGuid());
    ...
    call(methodsToCall, callback) {
        ...
        async.map(methodsToCall, (methodToCall, innerCallback) => {
            ...
            call_helpers_1.callMethodHelper(this.context, this.addressSpace, callMethodRequest, (err, result) => {
