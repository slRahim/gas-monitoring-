...
function ensureDatatypeExtracted(addressSpace) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!addressSpacePriv.$$extraDataTypeManager) {
            ...
            yield node_opcua_client_dynamic_extension_object_1.populateDataTypeManager(session, dataTypeManager, true);
        }
            ...
            parser: {
                ...
                NamespaceIndex: {
                    finish() {
                        ...
                        const t = _translateNodeId(node_opcua_nodeid_1.resolveNodeId(`ns=${ns};i=1`).toString());
    ...
    function terminate(callback) {
        ...
        function finalSteps() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                postTasks3 = [];
                namespace_post_step_1.promoteObjectsAndVariables(addressSpace);
            });
        }
        finalSteps()
            .then(() => callback())
