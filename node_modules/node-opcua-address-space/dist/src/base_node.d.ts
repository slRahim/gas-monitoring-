...
import { BrowseDescription, RelativePathElement, RolePermissionType, RolePermissionTypeOptions } from "node-opcua-types";
...
export declare class BaseNode extends EventEmitter implements BaseNodePublic {
    ...
    findReferencesEx(strReference: string | UAReferenceTypePublic, browseDirection?: BrowseDirection): UAReferencePublic[];
    /**
