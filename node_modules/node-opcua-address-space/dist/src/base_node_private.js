...
function _clone_collection_new(newParent, collectionRef, optionalFilter, extraInfo) {
    ...
    for (const reference of collectionRef) {
        ...
        const options = {
            namespace,
            references: [new reference_1.Reference({ referenceType: reference.referenceType, isForward: false, nodeId: newParent.nodeId })]
        };
...
function _clone(Constructor, options, optionalFilter, extraInfo) {
    ...
    if (this.typeDefinition) {
        constructorOptions.references.push(new reference_1.Reference({
            isForward: true,
            nodeId: this.typeDefinition,
            referenceType: node_opcua_nodeid_1.resolveNodeId("HasTypeDefinition")
        }));
    }
    if (!constructorOptions.modellingRule) {
        if (this.modellingRule) {
            ...
            constructorOptions.references.push(new reference_1.Reference({
                ...
                referenceType: node_opcua_nodeid_1.resolveNodeId("HasModellingRule")
            }));
        }
    }
    else {
        namespace_private_1.UANamespace_process_modelling_rule(constructorOptions.references, constructorOptions.modellingRule);
    }
    constructorOptions.nodeId = namespace.constructNodeId(constructorOptions);
    node_opcua_assert_1.assert(constructorOptions.nodeId instanceof node_opcua_nodeid_1.NodeId);
