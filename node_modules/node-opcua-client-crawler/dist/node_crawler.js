...
class NodeCrawler extends node_crawler_base_1.NodeCrawlerBase {
    ...
    _reconstruct_manageable_object(queue, objMap, object, callback) {
        ...
        object.references.map((ref) => {
            ...
            /* istanbul ignore else */
            if (!reference) {
                warningLog(ref.nodeId.toString(), "bn=", ref.browseName.toString(), "class =", ref.nodeClass.toString(), ref.typeDefinition.toString());
            ...
            if (referenceType) {
                const refName = node_opcua_utils_1.lowerFirstLetter(((_a = referenceType === null || referenceType === void 0 ? void 0 : referenceType.browseName) === null || _a === void 0 ? void 0 : _a.name) || "");
