...
class RegisterServerManager extends events_1.EventEmitter {
    ...
    _establish_initial_connection(outer_callback) {
        ...
        const applicationName = ((_a = node_opcua_client_1.coerceLocalizedText(this.server.serverInfo.applicationName)) === null || _a === void 0 ? void 0 : _a.text) || undefined;
    ...
    _trigger_next() {
        ...
        node_opcua_assert_1.assert(this.state === RegisterServerManagerStatus.WAITING);
    ...
    _registerServer(isOnline, outer_callback) {
        ...
        const applicationName = ((_b = node_opcua_client_1.coerceLocalizedText(server.serverInfo.applicationName)) === null || _b === void 0 ? void 0 : _b.text) || undefined;
        ...
        node_opcua_assert_1.assert(this.state === RegisterServerManagerStatus.INITIALIZING || this.state === RegisterServerManagerStatus.WAITING);
