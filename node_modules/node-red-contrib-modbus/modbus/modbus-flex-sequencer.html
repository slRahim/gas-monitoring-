    ...
    oneditprepare: function () {
      ...
      */
      ...
      for (var i = 0; i < this.sequences.length; i++) {
        ...
        $("#node-input-sequences-container").editableList('addItem', sequence);
      }
...
style='display:none'> <div class='form-row'> <label for='node-input-server'><i class='icon-globe'></i> <span 
data-i18n='modbus-contrib.label.server'></span></label> <input type='text' id='node-input-server'> </div> <div 
class='form-row node-input-sequences-container-row'> <ol id='node-input-sequences-container'></ol> </div> </div> <div 
...
data-help-name='modbus-flex-sequencer'> </script>