...
function populateDataTypeManager(session, dataTypeManager, force) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield populate_data_type_manager_103_1.populateDataTypeManager103(session, dataTypeManager);
        // new way for 1.04 and later
        if (force) {
            yield populate_data_type_manager_104_1.populateDataTypeManager104(session, dataTypeManager);
        }
    });
}
