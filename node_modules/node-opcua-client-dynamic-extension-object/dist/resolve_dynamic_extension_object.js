...
function getOrExtractConstructor(session, binaryEncodingNodeId, dataTypeManager) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield populate_data_type_manager_104_1.readDataTypeDefinitionAndBuildType(session, dataTypeNodeId, r.browseName.name, dataTypeFactory, {});
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                ...
                warningLog(node_opcua_debug_1.hexDump(opaque.buffer));
