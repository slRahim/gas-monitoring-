...
class ExtraDataTypeManager {
    ...
    registerDataTypeFactory(namespaceIndex, dataTypeFactory) {
        ...
        node_opcua_assert_1.assert(namespaceIndex !== 0, "registerTypeDictionary cannot be used for namespace 0");
    ...
    getDataTypeFactoryForNamespace(namespaceIndex) {
        node_opcua_assert_1.assert(namespaceIndex !== 0, "getTypeDictionaryForNamespace cannot be used for namespace 0");
