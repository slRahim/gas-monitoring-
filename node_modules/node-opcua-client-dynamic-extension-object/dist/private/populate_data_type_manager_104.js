...
function readDataTypeDefinitionAndBuildType(session, dataTypeNodeId, name, dataTypeFactory, cache) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const schema = yield convert_data_type_definition_to_structuretype_schema_1.convertDataTypeDefinitionToStructureTypeSchema(session, dataTypeNodeId, name, dataTypeDefinition, dataTypeFactory, cache);
            node_opcua_schemas_1.createDynamicObjectConstructor(schema, dataTypeFactory);
        }
        catch (err) {
            errorLog("Error", err);
        }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function withDataType(dataTypeNodeId, r) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    node_opcua_assert_1.assert(dataTypeFactory.getConstructorForDataType(dataTypeNodeId));
                }
                catch (err) {
                    errorLog("err=", err);
                }
        ...
        function performAction(done) {
            ...
            function flushBrowse() {
                node_opcua_assert_1.assert(busyCount >= 0);
            ...
            browseSubDataTypeRecursively(node_opcua_nodeid_1.resolveNodeId("Structure"));
        }
